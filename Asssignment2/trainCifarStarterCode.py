...
tf_data = tf.placeholder(tf.float32, [None, imsize, imsize,
...
feed_test = {tf_data: Test, tf_labels: LTest, keep_prob: 1.0}
activation1 = h_conv1.eval(feed_dict=feed_test)
activation2 = h_conv2.eval(feed_dict=feed_test)

print("test accuracy %g" % accuracy.eval(feed_dict=feed_test))
